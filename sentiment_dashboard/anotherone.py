...
if analyze_button:
    if quick_text and quick_text.strip():
        with st.spinner("Analyzing..."):
            ...
            # No st.rerun() needed; state updates will trigger UI refresh
    else:
...
with tab_batch:
    ...
    if uploaded_file:
        try:
            ...
            if not is_valid:
                st.error(f"❌ {message}")
                st.info("💡 **Tip**: Your file should have a 'text' column containing valid text data.")
                st.stop()
